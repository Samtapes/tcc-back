...
var MessagesController = /** @class */ (function () {
    ...
    MessagesController.prototype.createMessage = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var consult_id, sender_id, text, message_id, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        consult_id = req.params.consult_id;
                        sender_id = req.headers.authorization;
                        text = req.body.text;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, messagesService.createMessage({ consult_id: consult_id, sender_id: sender_id, text: text })];
                    case 2:
                        message_id = _a.sent();
                        return [2 /*return*/, res.json({ message_id: message_id })];
                    case 3:
                        err_1 = _a.sent();
    ...
    MessagesController.prototype.getMessages = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var consult_id, sender_id, messages, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        consult_id = req.params.consult_id;
